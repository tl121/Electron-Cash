...
#tmp fix by tl121 to test with squasfs rather than squashfskit which wouldn't build in ub22.04.
mkdir  "$BUILDDIR/squashfskit"
...
"$MKSQUASHFS" \$args
EOF
    chmod 777 ./squashfs-root/AppRun  #test if a protection problem
